...
const char* ssid = "2Lykeio";        //SSID of Wifi network
const char* password = "erg@stirio";   // Password of wifi network
 
#define emailSenderAccount    "georgiatsirigoti@gmail.com"    // Sender email address
#define emailSenderPassword   "GNT*6702"            // Sender email password
